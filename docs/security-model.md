...
| Unauthorized mutation | Operator role plus exact one-use approval; scanners have no mutation path |
...
| Audit loss | Structured persistent events, DynamoDB PITR and CloudTrail validation |
